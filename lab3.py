...
# Email: < Atanu Ghosh <atghosh@cs.stonybrook.edu>, Bhargava Mourya Venishetty <bvenishetty@cs.stonybrook.edu> >
...
EMAIL = "atghosh@cs.stonybrook.edu, bvenishetty@cs.stonybrook.edu"
